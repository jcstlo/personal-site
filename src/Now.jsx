    ...
    <div class="animate-load-page">
      <div class="mb-10">
        ...
        <ul class="mt-10 ml-5 mr-3">
          <li class="list-disc font-albert font-normal text-xl ml-3 text-lightModeText dark:text-darkModeText">Building a full-stack application with React and Django</li>
      ...
      <p class="font-albert font-light mb-10 ml-3 text-lightModeText dark:text-darkModeText">Last updated: July 11, 2024</p>
      <ContactMe></ContactMe>
      <Footer></Footer>
      </div>
  )
